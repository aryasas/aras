    ...
    >
      ...
      >
        <a
          ...
          style={{
            fontFamily:
              '"Libre Baskerville", "Iowan Old Style", Georgia, serif',
            fontWeight: 700,
            fontSize: 40,
            color: "#fff",
      ...
      <nav style={{ padding: "12px 0", flex: 1 }}>
        {items.map((it) => (
          <a
            ...
            style={{
              ...
              gap: 10,
              padding: "10px 24px",
              color: active === it.id ? "#fff" : "rgba(255,255,255,.85)",
              background: active === it.id ? C.brandDeep : "transparent",
              fontSize: 13,
              cursor: "pointer",
              textDecoration: "none",
            }}
          >
            <i
              className={it.icon.startsWith("fa") ? it.icon : it.icon}
        ...
        <a
          ...
          style={{
            ...
            gap: 10,
            padding: "10px 24px",
            color: active === "settings" ? "#fff" : "rgba(255,255,255,.75)",
            background: active === "settings" ? C.brandDeep : "transparent",
            fontSize: 13,
            cursor: "pointer",
          }}
        >
    ...
    >
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
        ...
        <i
          ...
          style={{ color: C.ink2, fontSize: 16 }}
        />
        ...
        >
          <div
            style={{
              ...
              height: 28,
              borderRadius: "50%",
              background: "linear-gradient(135deg,#5a6fd6,#1f2a44)",
              color: "#fff",
              display: "flex",
              alignItems: "center",
...
function MenuBar({ onNav }) {
  const apps = [
    ...
    { icon: "ti-layout-grid2", title: "App Manager", id: "apps" },
