...
Create gen_view_list_view_setting — framework-level per-user list preferences.
...
_DDL = """
CREATE TABLE IF NOT EXISTS `gen_view_list_view_setting` (
    ...
    UNIQUE KEY `uq_gen_view_list_view` (`user_id`, `doctype`),
...
def run(flask_app):
    ...
    logger.info("[m005] gen_view_list_view_setting: OK")
