...
from aras.erp.erp_core.models.fiscal import FiscalPeriod
from aras.erp.erp_core.services import sequence as seq_svc
from aras.erp.erp_core.services import audit as audit_svc
...
def _resolve_period(company_id: int, d: date_type):
    from aras.erp.erp_core.models.fiscal import FiscalYear
    return (
        FiscalPeriod.query
