# -*- coding: utf-8 -*-
from arasCore.lib.services.app_helper import AppHelper, ResourceDef, CustomRoute

from aras.soc.models import (
...
def _handle_feed():
    ...
    from aras.soc.services.feed_service import get_feed
...
def _handle_feed_public():
    from flask import request, jsonify
    from aras.soc.services.feed_service import get_public_feed
    page     = request.args.get("page", 1, type=int)
    per_page = request.args.get("page_size", 20, type=int)
...
def _handle_friends_list():
    ...
    from aras.soc.services import friendship_service as fs
