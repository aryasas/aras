...
const GlobalDialog: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-slate-900/40 backdrop-blur-sm animate-in fade-in duration-200">
      <div className={`w-full max-w-md bg-white rounded-3xl shadow-2xl border ${colors[dialog.type]} overflow-hidden animate-in zoom-in-95 duration-200`}>
        <div className="p-6">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="mt-2 text-sm text-slate-500 leading-relaxed whitespace-pre-wrap">
                {dialog.message}
              </p>
            </div>
          </div>
        ...
        <div className="px-6 py-4 bg-slate-50/50 flex items-center justify-end gap-3 border-t border-slate-100">
          ...
          <button
            ...
            className={`px-6 py-2 text-sm font-bold text-white rounded-xl transition-all shadow-lg ${buttonColors[dialog.type]}`}
          >
