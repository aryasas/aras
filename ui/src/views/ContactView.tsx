...
export default function ContactView() {
  ...
  return (
    <main className="mx-auto max-w-2xl px-6 py-12">
      <h1 className="text-3xl font-bold text-[var(--app-text)]">Contact</h1>
      ...
      <form onSubmit={handleSubmit} className="mt-8 space-y-5">
        ...
        <div>
          ...
          <textarea
            ...
            required
            rows={6}
            className="mt-2 w-full resize-y rounded-[var(--app-radius)] border border-[var(--app-border)] px-4 py-2.5 text-sm outline-none focus:border-indigo-400 focus:ring-2 focus:ring-indigo-100"
          />
        </div>

        {success && (
          <div className="rounded-[var(--app-radius)] border border-emerald-200 bg-emerald-50 px-4 py-3 text-sm font-medium text-emerald-700">
            Thank you
          </div>
        )}
