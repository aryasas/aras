...
export function boxSettingsToStyle(settings: BoxSettings): CSSProperties {
  return {
    ...
    marginRight: `${settings.margin.right}px`,
    marginBottom: `${settings.margin.bottom}px`,
    marginLeft: `${settings.margin.left}px`,
    paddingTop: `${settings.padding.top}px`,
    paddingRight: `${settings.padding.right}px`,
    paddingBottom: `${settings.padding.bottom}px`,
    paddingLeft: `${settings.padding.left}px`,
