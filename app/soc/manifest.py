...
def _handle_feed():
    ...
    from app.soc.services.feed_service import get_feed
...
def _handle_feed_public():
    from flask import request, jsonify
    from app.soc.services.feed_service import get_public_feed
    page     = request.args.get("page", 1, type=int)
    per_page = request.args.get("page_size", 20, type=int)
...
def _handle_friends_list():
    ...
    from app.soc.services import friendship_service as fs
