...
# claude-opus-4-8
# Register at import time (mirrors core/registry/core_sections.py) so that any
# consumer writing to a core_config.* key — e.g. apps/settings seed_series writing
# core_config.numbering.* — sees the section regardless of app-sync ordering.
