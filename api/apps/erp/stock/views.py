...
from .models import ProductCategory, Product, Warehouse, StockMovement, PriceList, PromoBundle, \
    ProductUom, PromoBundleItem, StockMovementLine
...
class ProductView(Aras.View):
    ...
    layout = [
        {
            "title": "General",
            "fields": ["name", "code", "category_id", "uom_id"]
        },
        {
...
class PriceListView(Aras.View):
    ...
    layout = [
        {
            "title": "General Info",
            "fields": ["price_type_id", "is_blanket", "min_qty"]
        },
        {
            "title": "Target",
            "fields": ["product_id", "product_category_id", "uom_id"]
        },
        {
            "title": "Price / Discount",
            "fields": ["price", "discount_pct"]
        },
        {
            "title": "Validity",
...
class PromoBundleView(Aras.View):
    ...
    layout = [
        {
            "title": "Bundle Config",
            "fields": ["price_type_id", "is_active"]
        },
        {
            "title": "Validity",
            "fields": ["valid_from", "valid_to"]
...
class StockMovementView(Aras.View):
    ...
    layout = [
        {
            "title": "General",
            "fields": ["number", "doc_date", "status"]
        },
        {
            "title": "Warehouses",
            "fields": ["from_warehouse_id", "to_warehouse_id"]
        },
        {
            "title": "Lines",
            "fields": ["lines"]
