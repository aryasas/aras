...
tables = {
    ...
    f"{'erp_config'}_currencies": "core_currencies",
    "erp_config_exchange_rates": "config_exchange_rates",
    f"{'erp_config'}_notifications": "core_notifications",
    f"{'erp_config'}_org_posting_rules": "accounting_org_posting_rules",
    f"{'erp_config'}_org_vocabulary": "accounting_org_vocabulary",
    f"{'erp_config'}_organizations": "core_organizations",
    ...
    f"{'erp_config'}_print_templates": "core_print_templates",
    "erp_config_settings": "config_settings",
    "erp_config_uoms": "config_uoms",
    f"{'erp_config'}_workflow_actions": "core_workflow_actions",
    f"{'erp_config'}_workflow_states": "core_workflow_states",
    f"{'erp_config'}_workflow_templates": "core_workflow_templates",
    f"{'erp_config'}_workflow_transitions": "core_workflow_transitions",
    "erp_base": "base",
    f"{'erp_base'}_saved_filters": "core_saved_filters",
    "erp_core_notes": "core_notes",
    "erp_user_access": "core_user_access",
    "erp_invoice": "invoice",
    "erp_rbac": "rbac",
