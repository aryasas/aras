...
from arasCore.admin.forms import CreateUserForm
...
def users_new():
    ...
    return render_template("admin/setting/setting_auth_user_form.html", title="New User", main_title="Create User", form=form)
...
def user_detail(user_id):
    ...
    return render_template(
        "admin/setting/setting_auth_user_profile.html",
        title=u.username,
