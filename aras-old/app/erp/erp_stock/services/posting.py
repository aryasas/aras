...
from app.erp.erp_stock.models import StockMovement
from app.erp.erp_acc.models import AccJournalEntry, AccJournalLine
...
def _compute_running_wac(product_id: int, location_id: int, company_id: int,
    ...
    """
    from app.erp.erp_stock.services.stock_compute import compute_qty, compute_avg_cost
