...
from app.erp.erp_sup.models.purchase_order import PurchaseOrder, PurchaseOrderLine, PurchaseOrderCharge
from app.erp.erp_acc.models.invoice import AccPurchaseInvoice, AccPurchaseInvoiceLine, AccPurchaseInvoiceCharge
...
def create_invoice_from_order(order_id: int) -> AccPurchaseInvoice:
    ...
    inv_name = seq_svc.next_code(order.company_id, "accounting.purchase_invoice", default_format="PI-{YYYY}-{####}")
